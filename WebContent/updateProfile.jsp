  ...
  <body>
	...
	<form name="input" class="form-horizontal" action="${checkUpdate}" method="POST">
			...
			<div class="col-xs-3">
			 ...
			 <input type="text" class="form-control" id="id6" placeholder="${userObject.firstName}" name="${firstName}">
			</div> 
			</div> 
			<div class="form-group">	
			<div class="col-xs-3">
			 <label for="id7">Last name</label>
			 <input type="text" class="form-control" id="id7" placeholder="${userObject.lastName}" name="${lastName}">
			</div> 
			</div> 
